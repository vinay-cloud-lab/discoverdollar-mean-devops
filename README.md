...
Instance type: Any
Storage: 20 GB
Configure Security Group to allow: All traffic allowed (for testing purpose)
...
Configure Pipeline
Under General:
Select GitHub hook trigger for GITScm polling (Build Triggers)

Under Pipeline:
Definition → Pipeline script
Copy and paste the Jenkins pipeline script
Click Apply
Click Save
